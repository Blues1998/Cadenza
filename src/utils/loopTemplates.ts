...
export const LOOP_TEMPLATES: LoopTemplate[] = [
  ...
  { id: 't-c-g-am-f', name: 'First F', level: 4, note: 'Three you have and one you are learning', tempo: 78, beatsPerBar: 4, chords: [['C', 1], ['G', 1], ['Am', 1], ['F', 1]] },
  { id: 't-g-bm-c-d', name: 'Bm in passing', level: 4, note: 'Bm on the way past, not on the downbeat', tempo: 80, beatsPerBar: 4, chords: [['G', 1], ['Bm', 1], ['C', 1], ['D', 1]] },
  { id: 't-am-g-f-e', name: 'Andalusian', level: 4, note: 'The Andalusian walk down', tempo: 78, beatsPerBar: 4, chords: [['Am', 1], ['G', 1], ['F', 1], ['E', 1]] },
  ...
  { id: 't-ii-v-i', name: 'Two-five-one', level: 5, note: 'Two-five-one — the cadence jazz is made of', tempo: 92, beatsPerBar: 4, chords: [['Dm7', 1], ['G7', 1], ['Cmaj7', 2]] },
  { id: 't-e-blues', name: 'Open sevenths', level: 5, note: 'Dominant sevenths in the shapes that fit open strings', tempo: 88, beatsPerBar: 4, chords: [['E7', 2], ['A7', 1], ['B7', 1]] },

  // 6 — no new shape you have not met by now, only more of them and less time.
  { id: 't-am-dm-e7', name: 'Minor cadence', level: 6, note: 'A minor cadence that actually closes', tempo: 84, beatsPerBar: 4, chords: [['Am', 1], ['Dm', 1], ['E7', 1], ['Am', 1]] },
  { id: 't-circle', name: 'Round the circle', level: 6, note: 'Round the circle, one chord a bar', tempo: 92, beatsPerBar: 4, chords: [['Cmaj7', 1], ['Am7', 1], ['Dm7', 1], ['G7', 1]] },
